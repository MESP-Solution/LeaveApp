...
export function DesktopLoginView({
  ...
  return (
    <div className="relative min-h-[100dvh] grid grid-cols-2 bg-[#f6f7f9] overflow-hidden">
      ...
      {/* LEFT PANEL: Brand Info & Mesh Gradients */}
      <section className="relative flex flex-col justify-between p-12 bg-[#080d19] text-white overflow-hidden">
        ...
        <div className="relative z-10 flex items-center gap-3 animate-fade-in-up" style={{ animationDelay: "100ms" }}>
          <Image src="/main-logo.png" alt="Logo" width={150} height={150} priority />
        </div>
